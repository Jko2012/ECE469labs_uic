...
module mips(input  logic        clk, reset,
  ...
  logic        memtoreg, branch, bne,  // added bne signal
               pcsrc, zero,
  ...
  controller c(instr[31:26], instr[5:0], zero,
               ...
               alusrc, regdst, regwrite, jump, bne,  // added bne signal
               alucontrol);
...
module controller(input  logic [5:0] op, funct,
  ...
  maindec md(op, memtoreg, memwrite, branch,
             alusrc, regdst, regwrite, jump, bne,  // added bne
             aluop);
  aludec  ad(funct, aluop, alucontrol);

  // OLD: assign pcsrc = branch & zero;
  assign pcsrc = branch & (zero ^  bne);  // supports beq and bne
endmodule
...
module maindec(input  logic [5:0] op,
  ...
  assign {regwrite, regdst, alusrc,
          branch, memwrite,
          memtoreg, jump, bne, aluop} = controls;  // added bne
...
module aludec(input  logic [5:0] funct,
  ...
  always_comb
    case(aluop)
      ...
      2'b11: alucontrol = 3'b111;  // slti added for partB
